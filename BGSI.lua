...
-- Misc Server
    ...
    MiscServer:Channel("Rewards"):Toggle("Auto Claim Play Time Rewards", false, function(Value)
    ...
    MiscServer:Channel("Rewards"):Toggle("Auto Claim Season Rewards", false, function(Value)
        _G.AutoCS = Value
    ...
    MiscServer:Channel("Automation"):Toggle("Auto Open Mystery Box", false, function(Value)
    ...
    MiscServer:Channel("Autumn Event"):Toggle("Auto Spin Autumn Wheel", false, function(Value)
    ...
    MiscServer:Channel("Autumn Event"):Toggle("Auto Buy Autumn Shop", false, function(Value)
